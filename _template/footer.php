        ...
        <div class="sidebar-content">
            ...
            <div id="secondary" class="widget-area" role="complementary">
                ...
                <aside id="categories-6" class="widget widget_categories"><h3 class="widget-title">Categories</h3><label
                        class="screen-reader-text" for="cat">Categories</label><select name="cat" id="cat" class="postform">
                        ...
                        <option class="level-0" value="12">Life&nbsp;&nbsp;(4)</option>
                        ...
                        <option class="level-0" value="18">PHP&nbsp;&nbsp;(8)</option>
                        <option class="level-0" value="19">Programming&nbsp;&nbsp;(16)</option>
                ...
                <aside id="linkcat-266" class="widget widget_links"><h3 class="widget-title">Tools</h3>
                    <ul class="xoxo blogroll">
                        <li><a href="https://www.digitalocean.com/?refcode=6ba177832a85" title="Cloud Web Hosting"
                               target="_blank">Digital Ocean</a></li>
