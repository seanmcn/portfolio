...
<head>
    ...
    <style type="text/css" title="dynamic-css" class="options-output">textarea:focus, input:focus { outline-color: #00b9e8; }
        ...
        .widget h3 { text-align: center; line-height: 55px; font-size: 22px; }
        ...
        .widget_calendar #today { background-color: #e9eaee; }

        .widget ul li a { color: #535353; }

        .social-widget ul li a { color: #737373; }

        .tagcloud a, .widget_categories span { color: #747474; }

        .tagcloud a, .widget_categories span { background-color: #eaeaea; }
        ...
        .entry-title, .entry-title a { line-height: 54px; color: #585858; font-size: 45px; }
    ...
    <script async="" type="text/javascript" src="//seanmcn.disqus.com/count.js"></script>
